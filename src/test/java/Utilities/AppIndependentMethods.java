...
/*	
	...
	*/
	 ...
	 */
     ...
     public void clickOnCalender(WebElement calendoBJ,  WebElement monthOBJBy, int i, WebElement yearObj,int j, String date ) throws Exception
     {
     ...
     public void clickObject(Object sendKeys) {
		...
		public void clickObject(WebElement element, String data) {
		    try {
		        ...
		        ((JavascriptExecutor) oBrowser).executeScript("arguments[0].value='"+data+"';", w2.until(ExpectedConditions.visibilityOf(element)));       
		    }
		    catch(Exception e)
		    {System.out.println(e);}
		}
		...
		public void Selectbyindex(WebElement ele,int index)
		{
		  ...
		  /**********************************************
      * * Method Name	: Select by index
	 * Purpose		: To select dropdownlist based on value
	 * Author		: Veena.kote
	 * Reviewer		:
	 * Example		: ;
  */
		...
		/**********************************************
      * * Method Name	: Select by index
	 * Purpose		: To select dropdownlist based on Text
	 * Author		: Veena.kote
	 * Reviewer		:
	 * Example		: ;
  */
