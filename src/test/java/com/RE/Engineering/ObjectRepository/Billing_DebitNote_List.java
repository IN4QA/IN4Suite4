...
import com.RE.Engineering.Test.Billing_DebitNote_List_Test;
...
public class Billing_DebitNote_List extends Billing_DebitNote_List_Test {
	...
	public static void subprojectDD(WebElement comPath, String select_Subproject) {
		Select sct = new Select(comPath);
		sct.selectByVisibleText(select_Subproject);
	}
