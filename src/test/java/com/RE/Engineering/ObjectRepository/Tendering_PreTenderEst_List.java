...
import com.RE.Engineering.Test.Tendering_PreTenderEst_List_Test;
...
public class Tendering_PreTenderEst_List extends Tendering_PreTenderEst_List_Test {
	...
	private WebElement Pretenderestimation;
	public void getPreTenderEstlink() {
		Pretenderestimation.click();
	}
...
/*	public static void project() throws Throwable {
		...
		Frames.rightFrame();
		String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
		singleDD(PreTenderEstimation.getProject(), sheet.getRow(0).getCell(1).getStringCellValue());
		Thread.sleep(1000);
		PreTenderEstimation.getGo();
		Thread.sleep(2000);
		ListPageCount.PageCount(nameofCurrMethod,sheetname,Engineering.path);
