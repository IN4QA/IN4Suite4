...
import com.RE.Purchase.Create.Test.Supp_MultiRecovery_Create_Test;
...
public class Supp_MultiRecovery_Create extends Supp_MultiRecovery_Create_Test{
	...
	public Supp_MultiRecovery_Create(WebDriver oDriver) {
		iDriver=oDriver;
...
//				}
				...
				if (appInd.AlertPresent()) {
					Datatable.writeExcel("Indent", "Indent is Not Created", SuppMultiRecoveryOutput,Purchase.OutputCreatePath);
					System.out.println("Indent is Not Created");
				} else {
					Datatable.writeExcel(IndentNo, "Indent is Created", SuppMultiRecoveryOutput,Purchase.OutputCreatePath);
					System.out.println(IndentNo+"  Indent is Created");
				}
			} catch (Exception e) {
				Datatable.writeExcel("Indent", "Indent is not Created-Exception", SuppMultiRecoveryOutput,Purchase.OutputCreatePath);
...
//			Thread.sleep(1000);
	...
	public void PurchaseOrder()throws Throwable{
		...
		if(appInd.AlertPresent()) {
			Datatable.writeExcel("PurchaseOrder", "is Not Created", SuppMultiRecoveryOutput,Purchase.OutputCreatePath);
			System.out.println("  Purchase Order is Not Created");
		}else{
			
			Datatable.writeExcel(PurchaseOrder_No, "PO is Created", SuppMultiRecoveryOutput,Purchase.OutputCreatePath);
			System.out.println(PurchaseOrder_No+"  Purchase Order is Created");
		}
			}catch (Exception e) {
				Datatable.writeExcel("Purchase Order", "is Not Created -Exception ", SuppMultiRecoveryOutput,Purchase.OutputCreatePath);
...
//			Thread.sleep(1000);
	...
	public void GRN() throws Throwable{
		...
		getGRNupdatestatus();
		if(appInd.AlertPresent()) {
			Datatable.writeExcel("GRN", "Not Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("  GRN is Not Created");
		}else {
			Datatable.writeExcel(GRN_No, "GRN is Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println(GRN_No + "  GRN IS CREATED ");
		}
		}catch (Exception e) {
			Datatable.writeExcel("GRN", "Not Created Exception", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
...
//Crating Supplier Advance
	...
	String SuppAdvance_1;
	String SuppAdvance_2;
	String SuppAdvance_3;
	
	public void CreateSuppAdvanace() throws Throwable {
		for(int i=1;i<=sheetAdv.getLastRowNum();i++) {
	try {
		MenuSubMenuAdvance();
		getSuppAdvlink();
		Frames.rightFrame();
		getCreateSuppAdvButton();
		appInd.singleDropDown(getAdvCompanyDD(), sheetAdv.getRow(i).getCell(0).getStringCellValue());
		Thread.sleep(1000);
		getAdvprojectDD().click();
		Thread.sleep(1000);
		appInd.createMultiDD_withText(getAdvprojectDD(), getAdvEnterProjDD(), sheetAdv.getRow(i).getCell(1).getStringCellValue(), getAdvListofProj());
		Thread.sleep(1000);
		getAdvSubprojectDD().click();
		Thread.sleep(1000);
		appInd.createMultiDD_withText(getAdvSubprojectDD(), getAdvEnterSubProjDD(), sheetAdv.getRow(i).getCell(3).getStringCellValue(), getAdvListofSubProj());
		Thread.sleep(1000);
		...
		//PurchaseOrder_No
		appInd.createMultiDD_withText(getPO_NoDD(), getEnterAdvPO(), PurchaseOrder_No, getEnterAdvListOfPO());
		Thread.sleep(1000);
		getSearchAdvPO();
		getAdvPORadio();
		Thread.sleep(2000);
		...
		getAdvInvoiceAmt().sendKeys(sheetAdv.getRow(i).getCell(5).getStringCellValue());;
		appInd.seletDate(getAdvInvoiceDate(), appInd.getDateAsSpecified(0));
		getAdvTaxImpact();
		getAdvPOQty().clear();
		appInd.isAlertPresent();
		Thread.sleep(2000);
		getAdvPOQty().sendKeys(sheetAdv.getRow(i).getCell(6).getStringCellValue());
		String parentRateTax=appInd.switchToChildWindow(Adv_AddRateTax);
		getAdv_Rate().clear();
		appInd.isAlertPresent();
		getAdv_Rate().sendKeys(sheetAdv.getRow(i).getCell(7).getStringCellValue());
		getAdvCalRate();
		getAdvSaveRate();
		appInd.switchToParentWindow(parentRateTax);
		Frames.rightFrame();
		appInd.singleDropDown(getAdvModeofPay(), sheetAdv.getRow(i).getCell(9).getStringCellValue());
		getAdvFavouring().sendKeys(sheetAdv.getRow(i).getCell(10).getStringCellValue());
		getAdvPayDueDate().sendKeys(appInd.getBackDatedDate(-30));
		getAdvRemarks().sendKeys("Supplier Advance Created Through Automation");
		getAdvDedTax();
		appInd.singleDropDown(getAdvDedTaxCategory(), sheetAdv.getRow(i).getCell(11).getStringCellValue());
		Thread.sleep(2000);
		appInd.singleDropDown(getAdvDedTaxPer(), sheetAdv.getRow(i).getCell(12).getStringCellValue());
		Thread.sleep(2000);
		//getAdvDedTaxableAmt().sendKeys(sheet.getRow(0).getCell(0).getStringCellValue());
		getAdvDedTax2();
		appInd.singleDropDown(getAdvDedTaxCategory2(),sheetAdv.getRow(i).getCell(13).getStringCellValue());
		Thread.sleep(2000);
		appInd.singleDropDown(getAdvDedTaxPer2(),sheetAdv.getRow(i).getCell(14).getStringCellValue());
		//getAdvDedTaxableAmt2().sendKeys(sheet.getRow(i).getCell(14).getStringCellValue());
		Thread.sleep(2000);
		getAdvCreate();
		Thread.sleep(2000);
		...
		if(appInd.AlertPresent())
		{
			Datatable.writeExcel("Supplier Advance", "Supplier is Not Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			
		}else {
			Datatable.writeExcel(Supplier_Advance_No, "Supplier Advance is  Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("Supplier Advance Number(Created) ----------"+Supplier_Advance_No);
	
		}
	}catch (Exception e) {			
		Datatable.writeExcel("Supplier Advance", "Supplier is Not Created-Exception", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
		}
		getAdvChangestatus();
		...
		AdvPayment(); 
		switch (i) {
		case 1:SuppAdvance_1=Supplier_Advance_No;
			
			break;
		case 2:SuppAdvance_2=Supplier_Advance_No;
		
		break;
		case 3:SuppAdvance_3=Supplier_Advance_No;
		...
		System.out.println("1st Advance --"+SuppAdvance_1);
		System.out.println("2nd Advance --"+SuppAdvance_2);
		System.out.println("3rd Advance --"+SuppAdvance_3);
	}
	public void AdvPayment() throws Throwable{
		...
		try {
		Frames.innerFrame();
		WebElement searchcompny=SuppMultiRecovery.getFinCertCompany();
	...
	//	String AdvancePaymentStatus=getpaymentstatus();
		if(getpaymentstatus().equals("Paid")) {
			Datatable.writeExcel(Supplier_Advance_No, "Supplier Advance is Paid", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("PAYMENT STATUS ---"+Supplier_Advance_No+" "+ getpaymentstatus());
		}else {
			Datatable.writeExcel(Supplier_Advance_No, "Supplier Advance is Not Paid", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("PAYMENT STATUS ---"+Supplier_Advance_No+" "+ getpaymentstatus());
		}
		}catch (Exception e) {
			Datatable.writeExcel(Supplier_Advance_No, "Supplier Advance is Not Paid-Exception", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
	...
	String SuppDNID;
	String SuppDebitNote_1;
	String SuppDebitNote_2;
	String SuppDebitNote_3;
	public void SuppDebitNoteCreation() throws Throwable{
		for(int i=1;i<=sheetSuppDN.getLastRowNum();i++) {
				try {	
				MenuSubMenuSuppDN();
				Thread.sleep(1000);
				getSuppDNlink();
				...
				//PurchaseOrder_No
				//PO/11Jul2023/A.G.E/149
				appInd.createMultiDD_withText(getPO_NoDD(), getEnterSuppDNEnterPO(),PurchaseOrder_No, getSuppDNListOfPO());
				getSearchAdvPO();
				getSuppDNPO_Radio();
				...
				if(appInd.AlertPresent()) {
					Datatable.writeExcel("Supplier Debit Note", "Not Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
				}else {
					Datatable.writeExcel(SuppDNID, "Supplier Debit Note Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
					System.out.println("Supplie DN "+SuppDNID+"  Created");
				}
				}catch (Exception e) {
					Datatable.writeExcel("Supplier Debit Note", "Not Created Exception", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			...
			switch (i) {
			case 1:
				SuppDebitNote_1=SuppDNID;
				break;
				
			case 2:
				SuppDebitNote_2=SuppDNID;
				break;
				
			case 3:
				SuppDebitNote_3=SuppDNID;
				break;
			...
			System.out.println("1st Supplier Debit Note"+SuppDebitNote_1);
			System.out.println("2nd Supplier Debit Note"+SuppDebitNote_2);
			System.out.println("3rd Supplier Debit Note"+SuppDebitNote_3);
...
//Advance Recovery
		...
		for(int j=0; j<=getOutstandingAdvancesCount().size(); j++) {
			AdvanceCount++;
			//SuppAdvance_1
			if(getOutstandingAdvancesCount().get(j).getText().equals(SuppAdvance_1))
			{
				Thread.sleep(2000);
			...
			System.out.println("Partial Supplier Advance Recoverey Exception"+e);
		}
		...
		try {
			...
			for(int j=0; j<=getOutstandingAdvancesCount().size(); j++) {
				AdvanceCount++;
				//SuppAdvance_2
				if(getOutstandingAdvancesCount().get(j).getText().equals(SuppAdvance_2))
				{
					Thread.sleep(2000);
					AdvanceCount = AdvanceCount + 1;
					Thread.sleep(3000);
					String AdvanceOustandingAmount=iDriver.findElement(By.xpath("//table[@id='gvAdvanceAdjustment']//tr["+AdvanceCount+"]//td[8]//span")).getText();
					Thread.sleep(1000);
					appInd.clickOutside();
					Thread.sleep(1000);
					iDriver.findElement(By.xpath("//table[@id='gvAdvanceAdjustment']//tr["+AdvanceCount+"]//td[9]//input[@type='text']")).sendKeys(AdvanceOustandingAmount);
					Thread.sleep(1000);
					break;		
				}
			}
			}catch (Exception e) {
				System.out.println(" Supplier Advance Full Recoverey Exception"+e);
			}
...
//Debit Note Recovery
		...
		for(int j=0; j<=getDebitNoteCount().size(); j++) {
			...
			if(getDebitNoteCount().get(j).getText().equals(SuppDebitNote_1))
			{
				Thread.sleep(2000);
		...
		try {
			...
			for(int j=0; j<=getDebitNoteCount().size(); j++) {
				...
				if(getDebitNoteCount().get(j).getText().equals(SuppDebitNote_2))
				{
					Thread.sleep(2000);
					DebitNoteCount = DebitNoteCount + 1;
					Thread.sleep(3000);
					////table[@id='gvDebitNote']//tr[14]//td[11]//input[@class='input']
					String OutstandingDebitNoteAmount=iDriver.findElement(By.xpath("//table[@id='gvDebitNote']//tr["+DebitNoteCount+"]//td[9]")).getText();
					System.out.println("OutstandingDebitNoteAmount---"+OutstandingDebitNoteAmount);
					Thread.sleep(1000);
					iDriver.findElement(By.xpath("//table[@id='gvDebitNote']//tr["+DebitNoteCount+"]//td[11]//input[@class='input']")).clear();
					Thread.sleep(5000);
					iDriver.findElement(By.xpath("//table[@id='gvDebitNote']//tr["+DebitNoteCount+"]//td[11]//input[@class='input']")).sendKeys(OutstandingDebitNoteAmount);
					Thread.sleep(5000);
					appInd.clickOutside();
					Thread.sleep(1000);
					break;		
...
//		appInd.singleDropDown(getSuppCertDedTaxCatPer2(),sheetPayment.getRow(1).getCell(13).getStringCellValue());
	 ...
	 SupperCertNo=getsuppcetNo();
		if (appInd.AlertPresent()) {
			Datatable.writeExcel("Supplier Certificate ",  "Supplier Certificate is Not Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
		} else {
			
			Datatable.writeExcel("Certificate No. "+SupperCertNo,  "Supplier Certificate is Created", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("Supplier Certificate Created--- "+SupperCertNo);
		}
		}catch (Exception e) {
			Datatable.writeExcel("Supplier Certificate ",  "Supplier Certificate is Not Created-Exception", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
		}
	...
	//	String AdvancePaymentStatus=getpaymentstatus();
		if(getSupppaymentstatus().equals("Paid")) {
			Datatable.writeExcel("Certificate No. "+SupperCertNo, "Suppier Payment is Paid", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("PAYMENT STATUS ---"+SupperCertNo+" "+ getSupppaymentstatus());
		}else {
			Datatable.writeExcel("Certificate No. "+SupperCertNo, "Suppier Payment is Not Paid", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("PAYMENT STATUS ---"+SupperCertNo+" "+ getSupppaymentstatus());
		}
		}catch (Exception e) {
			Datatable.writeExcel("Certificate No. "+SupperCertNo, "Suppier Payment is Not Paid-Exception", SuppMultiRecoveryOutput, Purchase.OutputCreatePath);
			System.out.println("PAYMENT STATUS ---"+SupperCertNo+" "+ getSupppaymentstatus());
		}
	}
