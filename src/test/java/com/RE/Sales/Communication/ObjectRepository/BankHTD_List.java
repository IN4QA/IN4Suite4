...
import com.RE.Sales.Communication.Test.BankHTD_List_Test;
...
public class BankHTD_List extends BankHTD_List_Test{
	...
	public BankHTD_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Bank (HTD)']")
	private WebElement BankHTD;
	public void getBankHTD() {
		BankHTD.click();
	}
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		BankHTDList.getBankHTD();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		BankHTDList.getGoButton();
		Thread.sleep(1000);
