...
import com.RE.Sales.Communication.Test.CapacityOfElectricity_List_Test;
...
public class CapacityOfElectricity_List extends CapacityOfElectricity_List_Test{
	...
	public CapacityOfElectricity_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Increase Capacity Of Electricity']")
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		CapacityOfElectricityList.getElectricity();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		CapacityOfElectricityList.getGoButton();
		Thread.sleep(1000);
