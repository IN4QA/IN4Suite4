...
import com.RE.Sales.Communication.Test.General_Request_List_Test;
...
public class General_Request_List extends General_Request_List_Test{
	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	
	public General_Request_List(WebDriver oDriver) {
		iDriver=oDriver;
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		GeneralRequestList.getGeneralRequest();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		GeneralRequestList.getGoButton();
		Thread.sleep(1000);
