...
import com.RE.Sales.Communication.Test.NameChange_List_Test;
...
public class NameChange_List extends NameChange_List_Test {
	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	
	public NameChange_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Name Change']")
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		NameChangeList.getnamechange();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		NameChangeList.getGoButton();
		Thread.sleep(1000);
