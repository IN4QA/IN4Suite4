...
import com.RE.Sales.Communication.Test.Other_Modifications_List_Test;
...
public class Other_Modifications_List extends Other_Modifications_List_Test{
	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	
	public Other_Modifications_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	@FindBy(xpath = "//a[text()='Other Modification(s)']")
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		modificationslist.getmodifications();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		modificationslist.getGoButton();
		Thread.sleep(1000);
