...
import com.RE.Sales.Communication.Test.Reselling_List_Test;
...
public class Reselling_List extends Reselling_List_Test{
	...
	public Reselling_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='ReSelling/Rental House']")
	private WebElement reselling;
	public void getresellinglink() {
		reselling.click();
	}
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		ResellingList.getresellinglink();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		ResellingList.getGoButton();
		Thread.sleep(1000);
