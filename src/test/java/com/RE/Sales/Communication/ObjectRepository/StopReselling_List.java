...
import com.RE.Sales.Communication.Test.StopReselling_List_Test;
...
public class StopReselling_List extends StopReselling_List_Test{
	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	
	public StopReselling_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Stop ReSelling/Rental House']")
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		StopResellingList.getrestopsellinglink();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		StopResellingList.getGoButton();
		Thread.sleep(1000);
