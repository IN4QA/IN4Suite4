...
import com.RE.Sales.Communication.Test.ThumbPrint_Request_List_Test;
...
public class ThumbPrint_Request_List extends ThumbPrint_Request_List_Test{
	...
	public ThumbPrint_Request_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Thumbprint Request']")
	private WebElement thumbprint;
	public void getthumbprintlink() {
		thumbprint.click();
	}
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		ThumbPrintRequestList.getthumbprintlink();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		ThumbPrintRequestList.getGoButton();
		Thread.sleep(1000);
