...
import com.RE.Sales.Communication.Test.UnitChange_List_Test;
...
public class UnitChange_List extends UnitChange_List_Test{
	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	
	public UnitChange_List(WebDriver oDriver) {
		iDriver=oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname=this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Unit No. Change']")
	private WebElement UnitChange;
	public void getUnitChange() {
		UnitChange.click();
	}
	...
	public void nofilter() throws Throwable{
		...
		Thread.sleep(1000);
		UnitChangeList.getUnitChange();
		Thread.sleep(1000);
		Frames.rightFrame();
		Thread.sleep(1000);
		UnitChangeList.getGoButton();
		Thread.sleep(1000);
