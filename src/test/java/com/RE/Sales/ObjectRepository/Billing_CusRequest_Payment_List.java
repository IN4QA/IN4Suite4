...
import com.RE.Sales.Test.Billing_CustomerRequest_Payments_List_Test;
...
public class Billing_CusRequest_Payment_List extends Billing_CustomerRequest_Payments_List_Test {
	...
	public Billing_CusRequest_Payment_List(WebDriver oDriver) {
		iDriver=oDriver;
