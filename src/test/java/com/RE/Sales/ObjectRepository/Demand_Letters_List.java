...
import com.RE.Sales.Test.Demand_Letters_List_Test;
...
public class Demand_Letters_List extends Demand_Letters_List_Test {

	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	public Demand_Letters_List(WebDriver oDriver) {
		iDriver = oDriver;
	...
	public void DemandprojectSubProjectCount() throws Throwable {
		Frames.SubMenuFrame();
		Thread.sleep(2000);
		Frames.rightFrame();
