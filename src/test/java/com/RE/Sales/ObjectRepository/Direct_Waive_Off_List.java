...
import com.RE.Sales.Test.Direct_Waive_Off_List_Test;
...
public class Direct_Waive_Off_List extends Direct_Waive_Off_List_Test{

	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	public Direct_Waive_Off_List(WebDriver oDriver) {
		iDriver = oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname = this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text() = 'Direct Waive Off']")
