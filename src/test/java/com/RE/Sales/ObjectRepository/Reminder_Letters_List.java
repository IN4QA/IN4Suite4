...
import com.RE.Sales.Test.Reminder_Letters_List_Test;
...
public class Reminder_Letters_List extends Reminder_Letters_List_Test {

	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	public Reminder_Letters_List(WebDriver oDriver) {
		iDriver = oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname = this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text()='Reminder Letters']")
	...
	public void ReminderprojectSubProjectCount() throws Throwable {
		Frames.SubMenuFrame();
		Thread.sleep(2000);
		getEnggMilestonelink();
		Frames.rightFrame();
