...
import com.RE.Sales.Test.Unit_Share_Type_List_Test;
...
public class Unit_Share_Type_List extends Unit_Share_Type_List_Test{

	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	public Unit_Share_Type_List(WebDriver oDriver) {
		iDriver = oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname = this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[contains(text(),'Unit Share Type')]")
	private WebElement unitShareType;
	public void getUnitShareType() {
		unitShareType.click();
	}
	...
	public void UnitShareType() throws Throwable {
		getUnitShareType();
		Thread.sleep(2000);
		Frames.rightFrame();
