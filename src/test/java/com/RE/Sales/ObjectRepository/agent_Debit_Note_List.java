...
import com.RE.Sales.Test.agent_Debit_Note_List_Test;
...
public class agent_Debit_Note_List extends agent_Debit_Note_List_Test{

	public static XSSFSheet sheet;
	public static Datatable xml;
	public static WebDriver iDriver;
	public static String sheetname;
	public agent_Debit_Note_List(WebDriver oDriver) {
		iDriver = oDriver;
	...
	@FindBy(css = "input#btnSADebitListGO")
