...
import com.RE.Sales.Test.sales_Payment_List_Test;
...
public class sales_Payment_List extends sales_Payment_List_Test{
	...
	public sales_Payment_List(WebDriver oDriver) {
		iDriver = oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname = this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text() = 'Sales Payments']")
	private WebElement salesPaymentLink;
	public void getSalesPaymentLink() {
		salesPaymentLink.click();
	}
