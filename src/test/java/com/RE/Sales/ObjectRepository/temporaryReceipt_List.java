...
import com.RE.Sales.Test.temporaryReceipt_List_Test;
...
public class temporaryReceipt_List extends temporaryReceipt_List_Test{
	...
	public temporaryReceipt_List(WebDriver oDriver) {
		iDriver = oDriver;
		PageFactory.initElements(iDriver, this);
		sheetname = this.getClass().getSimpleName();
	}
	
	@FindBy(xpath = "//a[text() = 'Temporary Receipts']")
	private WebElement tempReceiptsLink;
	public void getTempReceiptsLink() {
		tempReceiptsLink.click();
	}
